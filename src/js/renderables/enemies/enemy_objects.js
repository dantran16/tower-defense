...
class Level1 extends me.Stage {
    onResetEvent() {
        ...
        const onigiriEnemy = new Enemy(100, 50, { width: 32, height: 32, image: 'onigiri_image' }, 50, 4, 'Onigiri', 1);
        const redVelvetEnemy = new Enemy(200, 50, { width: 32, height: 32, image: 'red_velvet_image' }, 200, 1, 'Red Velvet Cake', 3);
        const coffeeEnemy = new Enemy(300, 50, { width: 32, height: 32, image: 'coffee_image' }, 100, 2, 'Coffee', 5);
